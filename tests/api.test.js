/**
 * SignLex Backend - API Integration Tests
 * Author: Amin Memon
 *
 * Tests Express routing, middleware, and response structure.
 * Mongoose models are fully mocked to avoid needing a real DB.
 */

// ── Mock all Mongoose models BEFORE any require ──
const mockUser = {
...
// Mock mongoose.connect to prevent real DB connection
jest.mock("mongoose", () => {
...
beforeEach(() => {
  ...
  // User.findOne returns our mock user by default
  ...
  // Also handle direct .find() calls that don't chain
